                    ...
                    <div className="[ lg:flex lg:items-center ] [ fancy-corners fancy-corners--large fancy-corners--top-left fancy-corners--bottom-right ] position: relative; transform-style: preserve-3d;">
                      ...
                      <div className="p-2 bg-grey">
                        <div className="leading-relaxed">
                          ...
                          <p className="mt-4">
                          Join us for our upcoming event at the Sacramento State Well, where we'll dive into the exciting world of Electronic Engineering.&nbsp;Whether you're a seasoned enthusiast or simply curious about the field, everyone is invited to join us in exploring the latest advancements in electronic technology.
                          </p>
                          <p className="mt-4">
