...
const customTheme: CustomFlowbiteTheme["carousel"] = {
  root: {
    ...
    "leftControl": "absolute -left-8 top-0 flex h-full items-center justify-center px-4 focus:outline-none ",
    "rightControl": "absolute -right-11 top-0 flex h-full items-center justify-center px-4 focus:outline-none"
  },  control: {
