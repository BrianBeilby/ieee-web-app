  ...
  return (
    <div className="container my-24 mx-auto md:px-6">
      <section className="mb-32">
        <div className="relative h-[800px] overflow-hidden bg-contain bg-[50%] bg-no-repeat bg-[url('https://photos.smugmug.com/Sac-State-Zoom-Backgrounds/i-pq67m2m/1/FgZFW8JwS5dnd5Q9DZ6rCDNvFRgqhcLFRmBPHqzSQ/O/guywestbridge_aerial.png')]"></div>
